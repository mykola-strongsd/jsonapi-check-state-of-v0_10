class SeedGenerator
  ...
  def generate
    ...
    user_4_access_limited = User.create!(username: 'user 4 / access limited', access: :limited)
    ...
    article_without_author_comments = Article.create!(title: 'article_with_author_comments', author: user_with_articles)
    ...
    User.all.each do |user|
      3.times do
        ...
        article_without_author_comments.comments.create!(content: 'comment', author: user)
      end
    end
